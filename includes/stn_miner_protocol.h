...
#define STN_MINER_JOB_HEADER_SIZE    116u
...
#define STN_MINER_JOB_SHARE_TARGET_OFFSET 40u
#define STN_MINER_JOB_CHAIN_TARGET_OFFSET 72u
#define STN_MINER_JOB_BLOCK_LENGTH_OFFSET 104u
#define STN_MINER_JOB_INITIAL_NONCE_OFFSET 108u

#define STN_MINER_SHARE_FACTOR 10u
